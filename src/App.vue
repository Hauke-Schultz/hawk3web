...
// Methods - toggleTheme kann entfernt werden, da nicht mehr vom Header verwendet
// Nur noch handleThemeChange für Settings wird benötigt
...
<template>
  <div class="container" :class="theme" role="application"><!-- Home View -->
    ...
    <!-- Settings View bleibt unverändert -->
