  ...
  const collectItem = (item) => {
    switch (item.type) {
      ...
      case 'healthPotion':
        ...
        console.log(`Health Potion collected! Max Health increased to: ${gameState.maxHealth}`)
        break
      ...
      case 'manaPotion':
        ...
        console.log(`Mana Potion collected! Max Mana increased to: ${gameState.maxMana}`)
        break
    }
  }
