  ...
  portfolio: {
	...
	shop: {
      ...
      gifts: 'Geschenke'
		...
		buy_confirm: 'Diesen Artikel kaufen?',
		buy_now: 'Jetzt kaufen',
		cant_afford: 'Zu teuer',
		item_cost: 'Artikelkosten',
		your_balance: 'Dein Guthaben',
		after_purchase: 'Nach dem Kauf',
		owned: 'Besessen',
		one_time_purchase: 'Einmalkauf',
		empty_category: 'Keine Artikel',
		empty_category_description: 'Schau später vorbei!',
		price: 'Preis',
		insufficient_funds_message: 'Du brauchst mehr Münzen oder Diamanten für diesen Artikel.',
    ...
    gifts: {
      ...
      daily_limit_message: 'Komm morgen wieder!',
      ...
      gift_received_from: '{itemName} von {senderName} erhalten!',
      already_redeemed: 'Dieser Geschenkcode wurde bereits verwendet',
    ...
    app_already_installed: 'App ist bereits installiert',
		...
		backup_restore_description: 'Exportiere deine Spieldaten als Sicherungsdatei oder importiere eine frühere Sicherung, um deinen Fortschritt wiederherzustellen.',
    ...
    first_record: 'Erster Rekord!',
    new_record: 'Neuer Rekord!',
    top_5_achievement: 'Top-5 Platzierung!',
    screenshot_auto_saved: 'Screenshot automatisch gespeichert',
    first_screenshot_ever: 'Dein allererster Screenshot für dieses Level!',
    new_top_score: 'Neuer Bestwert! Vorheriger Rekord: {beatScore} Punkte',
    top_ranking_achieved: 'Platz #{rank} erreicht! Übertroffen: {beatScore} Punkte',
    added_to_top_list: 'Zur Top-{total} Liste hinzugefügt! (Platz #{rank})',
    top_5: 'Top 5',
		stats: {
  ...
  hawkDungeon: {
	...
	achievements: {
      ...
      hawkTower: 'Hawk Tower Spiel',
		...
		definitions: {
			...
			hawkFruit_beginner: {
				...
				description: 'Erstes HawkFruit Level abgeschlossen'
			},
			hawkFruit_intermediate: {
				name: 'Frucht-Zusammenfüger',
				description: 'HawkFruit Level 3 abgeschlossen'
			},
			hawkFruit_expert: {
				name: 'Zusammenfüge-Experte',
				description: 'HawkFruit Level 5 abgeschlossen'
			},
			hawkFruit_master: {
				name: 'Zusammenfüge-Meister',
				description: 'Die ultimative HawkFruit Herausforderung abgeschlossen'
			},
			endless_first_play: {
      ...
      num_beginner: {
        ...
        description: 'Erstes HawkDoubleUp Level abgeschlossen'
      },
      num_intermediate: {
        name: 'Nummer Aufsteiger',
        description: 'HawkDoubleUp Level 3 abgeschlossen'
      },
      num_expert: {
        name: 'Nummer Experte',
        description: 'HawkDoubleUp Level 5 abgeschlossen'
      },
      num_master: {
        name: 'Nummer Meister',
        description: 'Die ultimative HawkDoubleUp Herausforderung abgeschlossen'
      },
      ...
      hawkFruit_perfectionist: {
        name: 'Hawk Fruit Perfektionist',
        description: 'Alle Hawk Fruit-Level mit 3 Sternen abgeschlossen'
      },
      hawkDoubleUp_perfectionist: {
        name: 'Hawk Double Up Perfektionist',
        description: 'Alle Hawk Double Up-Level mit 3 Sternen abgeschlossen'
      },
