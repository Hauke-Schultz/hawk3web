...
export default {
  ...
  pwa: {
    install_title: 'Install Hawk3 App',
    install_message: 'Install Hawk3 for the best gaming experience! Play offline, get faster loading, and enjoy an app-like experience.',
    install_button: 'Install App',
    ios_instructions: 'To install this app on your iPhone/iPad:',
    ios_step1: 'Tap the share button',
    ios_step2: 'Then tap "Add to Home Screen"',
    android_instructions: 'Click "Install" to add Hawk3 App to your home screen.',
  },
  ...
  portfolio: {
    ...
    welcome: {
      title: 'Welcome',
      description: 'Hello! I\'m Hauke Schultz, a passionate developer. Here you can find my projects and works. Feel free to explore!'
    },
    gamingHub: {
    ...
    gifts: {
      ...
      daily_limit_message: 'Come back tomorrow!',
      ...
      gift_received_from: 'Received {itemName} from {senderName}!',
      already_redeemed: 'This gift code has already been used',
      cannot_redeem_own_gift: 'You cannot redeem your own gift',
      item_already_owned: 'You already own this item',
      gift_expired: 'This gift code has expired',
      gift_sent_today: 'Sent Today',
      gift_received_today: 'Received Today',
      gift_received: 'Received',
      sent_gift_details: 'Sent Gift Details',
      sent_on: 'Sent on {date}',
      gift_code: 'Gift Code',
      reception_status: 'Reception Status',
      gift_was_received: 'Gift was received',
      marked_on: 'Marked on {date}',
  ...
  about: {
    ...
    install_app_description: 'Install Hawk3 as an app for better performance, offline access, and a native app experience.',
    app_already_installed: 'App is already installed',
		data_management: 'Data Management',
		backup_restore: 'Backup & Restore',
		backup_restore_description: 'Export your game data as a backup file or import a previous backup to restore your progress.',
	...
	gaming: {
		...
		hub: {
			title: 'Hawk3 Gaming Platform',
			description: 'Play exciting mini-games, collect achievements and compete against yourself! Dive into the Hawk3 Gaming Platform.'
		},
		...
		replay: 'Replay',
		saved_progress: 'Saved progress available',
		saved_just_now: 'Saved just now',
		saved_minutes_ago: 'Saved {minutes} minutes ago',
		saved_hours_ago: 'Saved {hours} hours ago',
		saved_days_ago: 'Saved {days} days ago',
		continue_game: 'Continue',
		start_fresh: 'Start Fresh',
		recent_games: 'Recent Games',
		last_played: 'Last Played',
		other_recent_levels: 'Other Recent Levels',
    first_record: 'First Record!',
    new_record: 'New Record!',
    top_5_achievement: 'Top-5 Achievement!',
    screenshot_auto_saved: 'Screenshot automatically saved',
    first_screenshot_ever: 'Your very first screenshot for this level!',
    new_top_score: 'New top score! Previous best: {beatScore} points',
    top_ranking_achieved: 'Rank #{rank} achieved! Beat score: {beatScore} points',
    added_to_top_list: 'Added to Top-{total} list! (Rank #{rank})',
    top_5: 'Top 5',
		stats: {
    ...
    next_fruit: 'Next',
		...
		hammer_mode_active: '🔨 Hammer Mode - Click a fruit to remove',
    hammer_mode_select: '🔨 Hammer Mode - Select fruit to remove',
    hammer_countdown_active: '🔨 Countdown active - Click again to cancel',
    cancel_hammer: 'Exit hammer mode',
    hammer_auto_activated: 'Hammer mode auto-activated!',
