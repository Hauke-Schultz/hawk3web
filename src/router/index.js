...
import MemoryLevels from '../views/MemoryLevels.vue'
import MemoryGame from '../views/MemoryGame.vue'
import FruitMergeLevels from '../views/FruitMergeLevels.vue'
import FruitMergeGame from '../views/FruitMergeGame.vue'
